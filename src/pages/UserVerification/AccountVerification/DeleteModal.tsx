...
const DeleteModal: React.FC<DeleteModalProps> = ({ close, IsOpen, primaryAction }) => {
        ...
        >
          ...
          >
            <TextView
              ...
              variant={isMWeb ? "Medium_26" : "Medium_22"}
              text={"Are you sure?"}
            />
            ...
            <TextView
              ...
              text={"This will delete your verified bank account on our platform. Exercise caution before confirming."}
            />
          </Box>
        </Box>
        <Box mt={3} />
